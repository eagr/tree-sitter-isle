...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [190] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_param_types_repeat1, 2, 0, 0), SHIFT_REPEAT(108),
  [193] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_param_types_repeat1, 2, 0, 0),
  ...
  [306] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_param_types_repeat1, 1, 0, 0),
  [308] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_param_types_repeat1, 1, 0, 0),
  ...
  [496] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_param_types, 2, 0, 0),
  ...
  [516] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_param_types, 3, 0, 0),
